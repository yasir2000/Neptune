...
namespace PDDLParser.Exp.Constraint
{
  ...
  public abstract class AbstractExistsExp<T> : QuantifiedExp<T>
    where T : class, IExp
  {
    /// <summary>
    ...
    public AbstractExistsExp(HashSet<ObjectParameterVariable> vars, T exp)
  ...
  /// </summary>
  public class ExistsConstraintExp : AbstractExistsExp<IConstraintExp>, IConstraintExp
  {
    /// <summary>
    /// Creates a new existential expression with the given quantified variables and
    ...
    public ExistsConstraintExp(HashSet<ObjectParameterVariable> vars, IConstraintExp exp)
      : base(vars, exp)
    {
      System.Diagnostics.Debug.Assert(exp != null && vars != null && !vars.ContainsNull());
    }
    ...
    {
      return new OrConstraintExp(GetBodySubstitutions());
    }
