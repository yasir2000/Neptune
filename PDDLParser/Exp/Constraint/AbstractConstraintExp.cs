...
namespace PDDLParser.Exp.Constraint
{
  ...
  /// </summary>
  public abstract class AbstractConstraintExp : AbstractExp, IConstraintExp
  {
    /// <summary>
    /// Creates a new constraint expression.
    /// </summary>
    public AbstractConstraintExp()
      : base()
    {
    }
    ...
    public abstract ProgressionValue Progress(IReadOnlyDurativeClosedWorld world, LocalBindings bindings);
    ...
    /// <exception cref="PDDLParser.Exception.BindingException">A BindingException is thrown if an attempt
    /// is made to evaluate an unbound variable.</exception>
    public abstract Bool EvaluateIdle(IReadOnlyDurativeClosedWorld idleWorld, LocalBindings bindings);
  }
}
