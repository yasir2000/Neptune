...
namespace PDDLParser.Exp.Logical
{
  ...
  /// </summary>
  public class ForallExp : AbstractForallExp<ILogicalExp>, ILogicalExp
  {
    /// <summary>
    ...
    public ForallExp(HashSet<ObjectParameterVariable> vars, ILogicalExp exp) 
      : base(vars, exp)
    {
    ...
    {
      return new AndExp(GetBodySubstitutions());
    }
