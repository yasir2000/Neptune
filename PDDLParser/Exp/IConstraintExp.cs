...
namespace PDDLParser.Exp
{
  ...
  /// </summary>
  public interface IConstraintExp : IExp
  {
    /// <summary>
    ...
    ProgressionValue Progress(IReadOnlyDurativeClosedWorld world, LocalBindings bindings);
    ...
    /// <exception cref="PDDLParser.Exception.BindingException">A BindingException is thrown if an attempt
    /// is made to evaluate an unbound variable.</exception>
    Bool EvaluateIdle(IReadOnlyDurativeClosedWorld idleWorld, LocalBindings bindings);
  }
}
